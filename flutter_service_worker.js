...
const BUILD_VERSION = '20260602123611';
...
const ASSETS = [
    ...
    "./assets/assets/images/templates_offers/abs.png",
    "./assets/assets/images/templates_offers/aerobics-1.png",
    "./assets/assets/images/templates_offers/aerobics-2.png",
    "./assets/assets/images/templates_offers/buddha%2520purnima.png",
    "./assets/assets/images/templates_offers/chest%2520workout.png",
    "./assets/assets/images/templates_offers/christmas%2520.png",
    "./assets/assets/images/templates_offers/christmas.png",
    "./assets/assets/images/templates_offers/diwali-1.png",
    "./assets/assets/images/templates_offers/diwali-2.png",
    "./assets/assets/images/templates_offers/dussehra.png",
    "./assets/assets/images/templates_offers/ganesh%2520chaturthi%2520.png",
    "./assets/assets/images/templates_offers/ganesh%2520chaturthi.png",
    ...
    "./assets/assets/images/templates_offers/leg%2520day.png",
    "./assets/assets/images/templates_offers/makar%2520sankranti.png",
    "./assets/assets/images/templates_offers/muharram.png",
    "./assets/assets/images/templates_offers/new%2520year.png",
    "./assets/assets/images/templates_offers/personal%2520training.png",
    "./assets/assets/images/templates_offers/personal%2520training-1.png",
    "./assets/assets/images/templates_offers/raksha%2520bandhan.png",
    "./assets/assets/images/templates_offers/ram%2520navami.png",
    "./assets/assets/images/templates_offers/surya%2520namashkar.png",
    "./assets/assets/images/templates_offers/tabata.png",
    "./assets/assets/images/templates_offers/tracking.png",
    "./assets/assets/images/templates_offers/vasant%2520panchami.png",
    "./assets/assets/images/templates_offers/weight%2520loss.png",
    "./assets/assets/images/templates_offers/yoga%2520day.png",
