...
export function checkAuthGuard() {
  ...
  const teacherPages = ['teacher-dashboard.html', 'teacher-profile.html', 'assign-stream.html', 'create-course.html', 'edit-course.html', 'course-details.html', 'pending-attendance.html', 'attendance-report.html', 'create-game.html', 'edit-game.html', 'lucky-spinner.html'];
  ...
  const studentTeacherPages = ['edit-profile.html', 'change-password.html', 'game-details.html', 'games.html', 'leaderboard.html', 'my-courses.html', 'attendance-history.html'];
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" style="border-radius: 12px; min-width: 220px;">
              ${role === 'admin' ? `
                <li><a class="dropdown-item py-2" href="./admin-dashboard.html"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                <li><a class="dropdown-item py-2" href="./admin-profile.html"><i class="bi bi-person me-2"></i>My Profile</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item py-2" href="./teacher-requests.html"><i class="bi bi-person-fill-exclamation me-2 text-warning"></i>Teacher Signup Requests</a></li>
                <li><a class="dropdown-item py-2" href="./student-requests.html"><i class="bi bi-mortarboard-fill me-2 text-primary"></i>Student Signup Requests</a></li>
                <li><a class="dropdown-item py-2" href="./teacher-streams.html"><i class="bi bi-person-video3 me-2 text-success"></i>Teacher Stream Assignments</a></li>
                <li><a class="dropdown-item py-2" href="./streams.html"><i class="bi bi-collection-fill me-2 text-info"></i>Academic Streams</a></li>
              ` : ''}
              ${role === 'teacher' ? `
                <li><a class="dropdown-item py-2" href="./teacher-dashboard.html"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                <li><a class="dropdown-item py-2" href="./teacher-profile.html"><i class="bi bi-person me-2"></i>My Profile</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item py-2" href="./my-courses.html"><i class="bi bi-journal-bookmark-fill me-2 text-success"></i>My Courses</a></li>
                <li><a class="dropdown-item py-2" href="./teacher-streams.html"><i class="bi bi-compass me-2 text-primary"></i>My Streams</a></li>
                <li><a class="dropdown-item py-2" href="./pending-attendance.html"><i class="bi bi-clock-history me-2 text-warning"></i>Pending Attendances</a></li>
                <li><a class="dropdown-item py-2" href="./attendance-report.html"><i class="bi bi-graph-up-arrow me-2 text-info"></i>Attendance Report</a></li>
                <li><a class="dropdown-item py-2" href="./games.html"><i class="bi bi-controller me-2 text-secondary"></i>Games Console</a></li>
                <li><a class="dropdown-item py-2" href="./leaderboard.html"><i class="bi bi-trophy-fill me-2 text-warning"></i>Leaderboard</a></li>
                <li><a class="dropdown-item py-2" href="./lucky-spinner.html"><i class="bi bi-compass-fill me-2 text-danger"></i>Lucky Spinner</a></li>
                <li><hr class="dropdown-divider"></li>
              ...
              ` : ''}
              ${role === 'student' ? `
                <li><a class="dropdown-item py-2" href="./student-dashboard.html"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                <li><a class="dropdown-item py-2" href="./student-profile.html"><i class="bi bi-person me-2"></i>My Profile</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item py-2" href="./my-courses.html"><i class="bi bi-journal-bookmark-fill me-2 text-success"></i>My Courses</a></li>
                <li><a class="dropdown-item py-2" href="./attendance-history.html"><i class="bi bi-calendar-check me-2 text-info"></i>Attendance History</a></li>
                <li><a class="dropdown-item py-2" href="./games.html"><i class="bi bi-controller me-2 text-secondary"></i>Classroom Games</a></li>
                <li><a class="dropdown-item py-2" href="./leaderboard.html"><i class="bi bi-trophy-fill me-2 text-warning"></i>Leaderboard</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item py-2" href="./edit-profile.html"><i class="bi bi-pencil-square me-2"></i>Edit Profile</a></li>
                <li><a class="dropdown-item py-2" href="./change-password.html"><i class="bi bi-key me-2"></i>Change Password</a></li>
