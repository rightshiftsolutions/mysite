...
export const gameSound = {
  ...
  // soft click when an option is picked (disabled)
  select() {
  ...
  // lock-in sting (KBC style "final answer" confirm) (disabled)
  lockIn() {
  ...
  // correct answer chime — bright ascending major triad (disabled)
  correct() {
  ...
  // wrong answer buzzer — descending dissonant tone (disabled)
  wrong() {
  ...
  // Bonus Points: coin/gem collect blip (disabled)
  coin() {
    // tone(988, 0.07, 'square', 0, 0.12);
    // tone(1318, 0.12, 'square', 0.06, 0.12);
  },

  // No Negative Marking: soft, friendly "all good" ding (disabled)
  softDing() {
    // tone(660, 0.16, 'sine', 0, 0.13);
    // tone(880, 0.16, 'sine', 0.05, 0.09);
  },

  // Negative Marking: sharper risk/warning blip (disabled)
  riskWarning() {
    // tone(180, 0.18, 'square', 0, 0.16);
    // noiseBurst(0.05, 0, 0.06, 800);
  },

  // KBC: tension "locking in" sting while the answer is being verified (disabled)
  locking() {
